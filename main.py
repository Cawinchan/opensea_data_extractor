...
def main(collection, number_of_nfts_per_collection=5000, order_direction="desc", order_by="sale_date",dir="data/raw/json",output_json_dir="data/preprocessed/json",output_media_dir="data/preprocessed/media"):
    '''
        args:
