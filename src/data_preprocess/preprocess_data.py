...
def extract_media(dir="data/raw/json",output_json_dir="data/preprocessed/json",output_media_dir="data/preprocessed/media"):    
    ...
    ''' NFT Metadata attributes
    {
        ...
        "eth_price": 9000000000000000000,                    # NFT last sale price without floating point in ETH 
        "eth_price_decimal": 18,
        "usd_price": 1200.89,                                # ETH-USD price for each day
        "eth_volume": 674188.0,                              # ETH-USD volume for each day
        "eth_marketcap": 45486894.2408,                     
        "transaction_time": "2021-07-23T10:16:28",           # Time of sale of NFT
        "media_filenames": ["1234.mp3", "1234.jpg"],
        "has_audio_in_video": false,                         # Check if Video has audio features
    }
